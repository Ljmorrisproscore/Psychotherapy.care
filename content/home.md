...
welcome:
  ...
  title: Are you ready to begin a journey towards healing and growth?
  body: |
...
reasons:
  ...
  items:
    - number: 1
      ...
      description: Therapy considers emotional, cognitive, relational, and body-based experience rather than treating symptoms in isolation.
    - number: 2
      title: Trauma-informed support
      description: Your pace matters. Sessions are designed to feel safe, collaborative, and respectful of your history.
    - number: 3
      title: Practical and reflective
      description: You will gain both insight and tools you can actually use outside the therapy room.
    - number: 4
      title: Modern, personalized care
      description: Care plans can be adapted for anxiety, trauma, life transitions, relationship challenges, burnout, or identity work.
    - number: 5
